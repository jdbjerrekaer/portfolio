...
console.log('🔧 Fixing 404.html to use custom NotFoundContent...\n');
...
if (root404 && hasCustomContent(root404)) {
  console.log('✓ 404.html already contains custom NotFoundContent');
  process.exit(0);
}

console.log('⚠ 404.html does not contain custom content');
...
if (notFound && hasCustomContent(notFound)) {
  console.log('✓ Found custom content in out/_not-found/index.html (from app/not-found.tsx)');
  console.log('Copying to out/404.html...');
  writeFile(root404Path, notFound);
  console.log('✓ Successfully copied custom 404 content to out/404.html');
  process.exit(0);
}

// Priority 2: Check if pages/404.tsx output exists and has custom content
if (pages404 && hasCustomContent(pages404)) {
  console.log('✓ Found custom content in out/404/index.html (from pages/404.tsx)');
  console.log('Copying to out/404.html...');
...
console.error('❌ ERROR: No custom NotFoundContent found in any location');
